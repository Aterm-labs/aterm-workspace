# aterm-workspace — guía para Claude Code
...
> **Este es el meta-repo (`aterm-workspace`, org Aterm-labs)**: agrupa todos los
> repos del proyecto como **submódulos** y centraliza el tooling (ver
> `Makefile` y `README.md`). Trabaja desde aquí con Claude para ver todo a la vez.
> Repos:
